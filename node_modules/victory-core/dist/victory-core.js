...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_includes__ = __webpack_require__(/*! lodash/includes */ 45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_property__ = __webpack_require__(/*! lodash/property */ 60);
...
function getPoint(datum) {
  ...
  return __WEBPACK_IMPORTED_MODULE_3_lodash_defaults___default()({}, point, datum);
}
...
function getStyles(style, defaultStyles) {
  ...
  var height = "100%";
  if (!style) {
    return __WEBPACK_IMPORTED_MODULE_3_lodash_defaults___default()({ parent: { height: height, width: width } }, defaultStyles);
  }
  var data = style.data,
      labels = style.labels,
      parent = style.parent;
  ...
  return {
    parent: __WEBPACK_IMPORTED_MODULE_3_lodash_defaults___default()({}, parent, defaultParent, { width: width, height: height }),
    labels: __WEBPACK_IMPORTED_MODULE_3_lodash_defaults___default()({}, labels, defaultLabels),
    data: __WEBPACK_IMPORTED_MODULE_3_lodash_defaults___default()({}, data, defaultData)
  };
}

function evaluateProp(prop, data, active) {
  return __WEBPACK_IMPORTED_MODULE_2_lodash_isFunction___default()(prop) ? prop(data, active) : prop;
}

function evaluateStyle(style, data, active) {
  if (!style || !Object.keys(style).some(function (value) {
    return __WEBPACK_IMPORTED_MODULE_2_lodash_isFunction___default()(style[value]);
  })) {
    return style;
  }
...
function modifyProps(props, fallbackProps, role) {
  ...
  return __WEBPACK_IMPORTED_MODULE_3_lodash_defaults___default()({}, props, themeProps, fallbackProps);
}
...
function reduceChildren(children, iteratee) {
  var rolesToSkip = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  ...
  var traverseChildren = function (childArray, parent) {
    return childArray.reduce(function (memo, child) {
      ...
      childIndex++;
      if (!__WEBPACK_IMPORTED_MODULE_0_lodash_includes___default()(rolesToSkip, childRole) && child.props && child.props.children) {
        var nestedChildren = __WEBPACK_IMPORTED_MODULE_4_react___default.a.Children.toArray(child.props.children);
...
var assignValue = __webpack_require__(/*! ./_assignValue */ 70),
...
var baseRest = __webpack_require__(/*! ./_baseRest */ 68),
    eq = __webpack_require__(/*! ./eq */ 39),
    isIterateeCall = __webpack_require__(/*! ./_isIterateeCall */ 69),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_color__ = __webpack_require__(/*! ./src/color */ 63);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_value__ = __webpack_require__(/*! ./src/value */ 62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_basis__ = __webpack_require__(/*! ./src/basis */ 65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__continuous__ = __webpack_require__(/*! ./continuous */ 51);
...
var baseAssignValue = __webpack_require__(/*! ./_baseAssignValue */ 71),
    eq = __webpack_require__(/*! ./eq */ 39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__victory_primitives_tspan__ = __webpack_require__(/*! ../victory-primitives/tspan */ 124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__victory_primitives_text__ = __webpack_require__(/*! ../victory-primitives/text */ 125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_curve_basis__ = __webpack_require__(/*! ./src/curve/basis */ 49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_curve_cardinal__ = __webpack_require__(/*! ./src/curve/cardinal */ 50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__src_curve_linear__ = __webpack_require__(/*! ./src/curve/linear */ 47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__curve_linear__ = __webpack_require__(/*! ./curve/linear */ 47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cardinal__ = __webpack_require__(/*! ./cardinal */ 50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_includes__ = __webpack_require__(/*! lodash/includes */ 45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isObject__ = __webpack_require__(/*! lodash/isObject */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isObject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_isObject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_pick__ = __webpack_require__(/*! lodash/pick */ 127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__victory_util_transitions__ = __webpack_require__(/*! ../victory-util/transitions */ 130);
...
var basePick = __webpack_require__(/*! ./_basePick */ 254),
    flatRest = __webpack_require__(/*! ./_flatRest */ 256);
...
var baseGet = __webpack_require__(/*! ./_baseGet */ 57),
    baseSet = __webpack_require__(/*! ./_baseSet */ 255),
...
var baseFlatten = __webpack_require__(/*! ./_baseFlatten */ 257);
...
var baseDifference = __webpack_require__(/*! ./_baseDifference */ 267),
    baseRest = __webpack_require__(/*! ./_baseRest */ 68),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_pick__ = __webpack_require__(/*! lodash/pick */ 127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__victory_transition_victory_transition__ = __webpack_require__(/*! ../victory-transition/victory-transition */ 126);
...
var Point = function (_React$Component) {
  ...
  _createClass(Point, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.cloneElement(pathComponent, { style: style, role: role, shapeRendering: shapeRendering, className: className, events: events, d: d });
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_props__ = __webpack_require__(/*! ./common-props */ 6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__rect__ = __webpack_require__(/*! ./rect */ 46);
...
var Flyout = function (_React$Component) {
  ...
  _createClass(Flyout, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.cloneElement(pathComponent, { style: style, className: className, shapeRendering: shapeRendering, role: role, events: events, d: path });
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__linear__ = __webpack_require__(/*! ./linear */ 47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__noop__ = __webpack_require__(/*! ../noop */ 48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cardinal__ = __webpack_require__(/*! ./cardinal */ 50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cardinal__ = __webpack_require__(/*! ./cardinal */ 50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_isPlainObject__ = __webpack_require__(/*! lodash/isPlainObject */ 61);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__exponent__ = __webpack_require__(/*! ./exponent */ 52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__continuous__ = __webpack_require__(/*! ./continuous */ 51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__victory_transition_victory_transition__ = __webpack_require__(/*! ./victory-transition/victory-transition */ 126);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__victory_util_transitions__ = __webpack_require__(/*! ./victory-util/transitions */ 130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__victory_primitives_rect__ = __webpack_require__(/*! ./victory-primitives/rect */ 46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__victory_primitives_tspan__ = __webpack_require__(/*! ./victory-primitives/tspan */ 124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__victory_primitives_text__ = __webpack_require__(/*! ./victory-primitives/text */ 125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isPlainObject__ = __webpack_require__(/*! lodash/isPlainObject */ 61);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_timer__ = __webpack_require__(/*! ./src/timer */ 66);
...
var assignValue = __webpack_require__(/*! ./_assignValue */ 70),
    baseAssignValue = __webpack_require__(/*! ./_baseAssignValue */ 71);
...
var basePickBy = __webpack_require__(/*! ./_basePickBy */ 128),
    hasIn = __webpack_require__(/*! ./hasIn */ 105);
...
var arrayPush = __webpack_require__(/*! ./_arrayPush */ 258),
    isFlattenable = __webpack_require__(/*! ./_isFlattenable */ 259);
...
var arrayMap = __webpack_require__(/*! ./_arrayMap */ 37),
    baseIteratee = __webpack_require__(/*! ./_baseIteratee */ 21),
    basePickBy = __webpack_require__(/*! ./_basePickBy */ 128),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__victory_primitives_rect__ = __webpack_require__(/*! ../victory-primitives/rect */ 46);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__noop__ = __webpack_require__(/*! ../noop */ 48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__basis__ = __webpack_require__(/*! ./basis */ 49);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__basis__ = __webpack_require__(/*! ./basis */ 49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__noop__ = __webpack_require__(/*! ../noop */ 48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__victory_util_helpers__ = __webpack_require__(/*! ../victory-util/helpers */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_props__ = __webpack_require__(/*! ./common-props */ 6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__rect__ = __webpack_require__(/*! ./rect */ 46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__continuous__ = __webpack_require__(/*! ./continuous */ 51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_isPlainObject__ = __webpack_require__(/*! lodash/isPlainObject */ 61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_includes__ = __webpack_require__(/*! lodash/includes */ 45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_flatten__ = __webpack_require__(/*! lodash/flatten */ 129);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data__ = __webpack_require__(/*! ./data */ 154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__scale__ = __webpack_require__(/*! ./scale */ 87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__helpers__ = __webpack_require__(/*! ./helpers */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__collection__ = __webpack_require__(/*! ./collection */ 19);
...
function cleanDomain(domain, props, axis) {
  var scaleType = __WEBPACK_IMPORTED_MODULE_6__scale__["a" /* default */].getScaleType(props, axis);
...
function getCumulativeData(props, axis, datasets) {
  var currentAxis = __WEBPACK_IMPORTED_MODULE_7__helpers__["a" /* default */].getCurrentAxis(axis, props.horizontal);
  var otherAxis = currentAxis === "x" ? "y" : "x";
  var categories = [];
  var axisValues = [];
  datasets.forEach(function (dataset) {
    dataset.forEach(function (data) {
      if (data.category !== undefined && !__WEBPACK_IMPORTED_MODULE_3_lodash_includes___default()(categories, data.category)) {
        categories.push(data.category);
      } else if (!__WEBPACK_IMPORTED_MODULE_3_lodash_includes___default()(axisValues, data["_" + otherAxis])) {
...
function getMaxFromData(dataset, axis) {
  ...
  var minValue = __WEBPACK_IMPORTED_MODULE_4_lodash_flatten___default()(dataset).reduce(function (memo, datum) {
...
function padDomain(domain, props, axis) {
  ...
  var min = __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMinValue(domain);
  var max = __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMaxValue(domain);
  var range = __WEBPACK_IMPORTED_MODULE_7__helpers__["a" /* default */].getRange(props, axis);
...
function createDomainFunction(getDomainFromDataFunction, formatDomainFunction) {
  ...
  return function (props, axis) {
    ...
    var categories = __WEBPACK_IMPORTED_MODULE_5__data__["a" /* default */].getCategories(props, axis);
...
function getDomainFromCategories(props, axis, categories) {
  categories = categories || __WEBPACK_IMPORTED_MODULE_5__data__["a" /* default */].getCategories(props, axis);
  var polar = props.polar,
  ...
  var minDomain = getMinFromProps(props, axis);
  var maxDomain = getMaxFromProps(props, axis);
  var stringArray = __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].containsStrings(categories) ? __WEBPACK_IMPORTED_MODULE_5__data__["a" /* default */].getStringsFromCategories(props, axis) : [];
  ...
  var min = minDomain !== undefined ? minDomain : __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMinValue(categoryValues);
  var max = maxDomain !== undefined ? maxDomain : __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMaxValue(categoryValues);
...
function getDomainFromData(props, axis, dataset) {
  dataset = dataset || __WEBPACK_IMPORTED_MODULE_5__data__["a" /* default */].getData(props);
  var horizontal = props.horizontal,
      polar = props.polar,
  ...
  var maxDomain = getMaxFromProps(props, axis);
  if (dataset.length < 1) {
    var scaleDomain = __WEBPACK_IMPORTED_MODULE_6__scale__["a" /* default */].getBaseScale(props, axis).domain();
    var _min = minDomain !== undefined ? minDomain : __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMinValue(scaleDomain);
    var _max = maxDomain !== undefined ? maxDomain : __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMaxValue(scaleDomain);
    return getDomainFromMinMax(_min, _max);
  }
  var currentAxis = __WEBPACK_IMPORTED_MODULE_7__helpers__["a" /* default */].getCurrentAxis(axis, horizontal);
...
function getDomainFromGroupedData(props, axis, datasets) {
  ...
  var categories = __WEBPACK_IMPORTED_MODULE_2_lodash_isPlainObject___default()(props.categories) ? props.categories[axis] : props.categories;
  ...
  return getDomainFromMinMax(__WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMinValue(globalDomain, cumulativeMin), __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMaxValue(globalDomain, cumulativeMax));
}
...
function getDomainWithZero(props, axis) {
  ...
  var ensureZero = function (domain) {
    ...
    var min = minDomain !== undefined ? minDomain : __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMinValue(domain, defaultMin);
    var max = maxDomain !== undefined ? maxDomain : __WEBPACK_IMPORTED_MODULE_8__collection__["a" /* default */].getMaxValue(domain, defaultMax);
