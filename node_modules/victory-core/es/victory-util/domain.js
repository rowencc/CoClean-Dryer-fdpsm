...
function getMaxFromData(dataset, axis) {
  ...
  var minValue = _flatten(dataset).reduce(function (memo, datum) {
...
function getDomainFromGroupedData(props, axis, datasets) {
  ...
  return getDomainFromMinMax(Collection.getMinValue(globalDomain, cumulativeMin), Collection.getMaxValue(globalDomain, cumulativeMax));
}
